...
import { discusSettings, neonTetraSettings,diamondTetraSettings, bluefaceAngelfishSettings} from "./settings"
        ...
        <>
            <Canvas style={{background:"#0c5e7d"}} camera={{position:[0,0,20],layers:[2]}} 
                ...
                <Suspense>
                    ...
                    <Boids fish={BluefaceAngelFish} position={[0,-20,10]} size={new THREE.Vector2(1,0.3)} depth={5} settings={bluefaceAngelfishSettings} avoidMouse={false} sceneHeight={sceneHeight}/>
